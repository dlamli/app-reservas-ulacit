    ...
    public class HabitacionController : ApiController
    {
            ...
            try
            {
                    ...
                    SqlConnection(ConfigurationManager.ConnectionStrings["RESERVAS"].ConnectionString))
                {
                    SqlCommand sqlCommand = new
                        SqlCommand(@"INSERT INTO HABITACION (HOT_CODIGO, HAB_NUMERO, 
                                                                    HAB_CAPACIDAD, HAB_TIPO, HAB_DESCRIPCION, 
                                                                    HAB_ESTADO, HAB_PRECIO) 
                                                             VALUES (@HOT_CODIGO, @HAB_NUMERO, 
                                                                   @HAB_CAPACIDAD, @HAB_TIPO, @HAB_DESCRIPCION, 
                                                                    @HAB_ESTADO, @HAB_PRECIO) ",
                                                                    sqlConnection);
        ...
        public IHttpActionResult Actualizar(Habitacion habitacion)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new
                        SqlCommand(@"UPDATE HABITACION SET HOT_CODIGO = @HOT_CODIGO , HAB_NUMERO = @HAB_NUMERO, 
                                                                    HAB_CAPACIDAD = @HAB_CAPACIDAD, HAB_TIPO = @HAB_TIPO, HAB_DESCRIPCION = @HAB_DESCRIPCION, 
                                                                    HAB_ESTADO = @HAB_ESTADO, HAB_PRECIO = @HAB_PRECIO
                                     WHERE HAB_CODIGO = @HAB_CODIGO", sqlConnection);
        ...
        public IHttpActionResult Eliminar(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new
                        SqlCommand(@"DELETE HABITACION WHERE HAB_CODIGO = @HAB_CODIGO", sqlConnection);
